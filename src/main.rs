        ...
        .run_with(|| {
            ...
            (
                Soulboard {
                    ...
                    available_teams: teams.clone(),
                    team_a_combo_state,
                    team_b_combo_state,
                    slot_map_combo_states,
                    slot_mode_combo_states,
                    mode_line_map_combo_states,
                    create_team_full_input: String::new(),
                    create_team_trunc_input: String::new(),
                    create_team_logo_path: None,
                    create_team_feedback: String::new(),
                    create_team_feedback_is_error: false,
                    selected_tab: 0,
                },
                Task::none(),
            )
